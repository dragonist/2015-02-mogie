	  ...
	  render:function () {
	    ...
	    for(var i = 0; i< sessionStorage.length; i++){
	      ...
	      var result = (React.createElement("li", {key: movie.id}, 
	        React.createElement("p", {className: "title"}, movie.title), 
	        React.createElement("p", {className: "rate"}, movie.rate)
	      ))
	      boxList.push(result);
	    }
	    ...
	    return (
	      React.createElement("section", {id: "resultWrapper"}, 
	        React.createElement("div", {id: "resultContainer"}, 
	          React.createElement("p", null, " 영화 평점 분포 그래프"), 
	          container
	        ), 
