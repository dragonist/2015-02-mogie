...
/***/ function(module, exports, __webpack_require__) {
	...
	/** @jsx React.DOM */var LineChart = __webpack_require__(1).Line;

	var app= {};
	app.SelectWrapper = "showSelectWrapper";
	app.ResultWrapper = "showResultWrapper";
	app.Movies = __webpack_require__(12);
	app.util = {
	...
	var BoxContainer = __webpack_require__(13);
	...
	var ResultWrapper = React.createClass({displayName: "ResultWrapper",
	  ...
	  render:function () {
	    ...
	    movieChart = React.createElement(LineChart, {data: chartData, options: chartOptions, redraw: true})
	    ...
	    movieList = (count === 0)? React.createElement("p", null, "평가한 영화가 없어요") : React.createElement(BoxContainer, {
	            movies: this.props.movies, 
	            addMovie: this.props.addMovie, 
	            removeMovie: this.props.removeMovie, 
	            filter: "true"})
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(){
		...
		var each = helpers.each = function(loopable,callback,self){
			...
			amd = helpers.amd = ("function" == 'function' && __webpack_require__(5)),
			//-- Math methods
...
/***/ function(module, exports, __webpack_require__) {
	...
	/** @jsx React.DOM */var MovieBox = __webpack_require__(14);
	    ...
	    boxContents = React.createElement("div", {className: "box-contents"}, 
	            React.createElement("div", {className: "contents"}, 
	              ...
	              React.createElement("div", {className: "rating"}, 
	                React.createElement("span", {"data-key": "1", onClick: this.onClick, className: rate[0]}), 
	                React.createElement("span", {"data-key": "2", onClick: this.onClick, className: rate[1]}), 
	                React.createElement("span", {"data-key": "3", onClick: this.onClick, className: rate[2]}), 
	                React.createElement("span", {"data-key": "4", onClick: this.onClick, className: rate[3]}), 
	                React.createElement("span", {"data-key": "5", onClick: this.onClick, className: rate[4]})
	              )
	            )
	          )
	    
	    return (
	      	React.createElement("li", {key: this.props.movie.id, className: movieBoxClassName, "data-key": this.props.movie.id}, 
	      		boxImage, 
	      		boxContents
	      	)
	    );
